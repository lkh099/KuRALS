...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        self.register_buffer("relative_position_index", relative_position_index) # register buffer to allow .cuda()

        # qkv_bias = True by default.
...
class BasicLayer(nn.Module):
    ...
    def forward(self, x, H, W):
        ...
        # refer help to: https://github.com/microsoft/Swin-Transformer/issues/38
        # Hp: Height after padding.
